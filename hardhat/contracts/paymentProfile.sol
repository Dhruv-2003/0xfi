...
contract paymentProfile is Ownable {
    ...
    /// To add the invoices for the user generated by external party
    function addInvoices(address _user,string memory _invoiceURI) public {
        UserProfile storage _profile = users[_user];
        _profile.push(_invoiceURI);
    }
}
